...
export const iconMap: Record<string, LucideIcon> = {
  ...
  // DEFAULT FALLBACK
  'default': Star,
    // HOTEL AMENITIES (from screenshots and common variations)
    '24-hour front desk': Clock,
    'front desk': Clock,
    'room service': UtensilsCrossed,
    'check-in': Clock,
    'check-in available': Clock,
    'electricity power backup': Zap,
    'power backup': Zap,
    'hot water': Waves,
    'hot water facility': Waves,
