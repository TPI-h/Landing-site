  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream via-white to-cream/50">
      ...
      <div className="relative z-20">
        ...
        {/* About Section */}
        <section className="relative py-20 bg-gradient-to-r from-white via-cream/30 to-white">
        ...
        {/* Rooms Section */}
        <section id="rooms" className="relative py-20 bg-gradient-to-l from-cream/50 via-white to-cream/50">
        ...
        {/* Attractions Section */}
        <section className="relative py-20 bg-gradient-to-br from-cream/50 via-white to-gold/5">
        ...
        {/* Amenities Section */}
        <section className="relative py-20 bg-gradient-to-r from-white via-navy/5 to-white">
          <div className="absolute inset-0">
            <div className="absolute top-0 left-1/4 w-96 h-96 bg-gold/10 rounded-full blur-3xl"></div>
            <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-navy/10 rounded-full blur-3xl"></div>
          </div>
          <div className="relative z-10">
        ...
        <section className="relative py-20 bg-gradient-to-r from-navy/5 via-white to-navy/5">
          <div className="absolute inset-0">
        ...
        {/* Location Section */}
        <section className="relative py-20 bg-gradient-to-t from-navy/10 via-cream/30 to-white">
